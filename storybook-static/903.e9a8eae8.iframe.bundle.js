...
(self.webpackChunk_nicoleokamoto_react_ui_component_library =
  ...
  [903],
  {
    './node_modules/@storybook/components/dist/formatter-2WMMO6ZP.mjs': (
      ...
      function kn(t8) {
        return (
          ('element' === t8.type && (!t8.namespace || de(t8)) && dn[t8.name]) ||
          mn
        );
      }
      function cr(
      ...
      function qn(t8, e) {
        return (
          !t8.isSelfClosing && !t8.endSourceSpan && (Ge(t8) || _t(t8.parent, e))
        );
      }
      function j(t8) {
        return (
      ...
      function ji(t8, e, r) {
        ...
        let s =
          ...
          o =
            ...
            0 === n.children.length,
          p =
            e.singleAttributePerLine && n.attrs.length > 1 && !Ce(n, e) ? S : A,
          l = [R([o ? ' ' : A, Y(p, a)])];
        return (
        ...
        let s = L(r.node),
          {
            ...
            if (
              !u.some((p, l) => !p && (0 === l || u.slice(l + 1).some(Boolean)))
            )
              return {
      ...
      function so(t8) {
        return (
          (t8 < 97 || 122 < t8) && (t8 < 65 || 90 < t8) && (t8 < 48 || t8 > 57)
        );
      }
      function io(t8) {
        return (
      ...
      var $s = function fo(t8, e) {
        ...
        er = class t7 {
          ...
          setProperty(e, r) {
            if (this[e] !== r) {
              if (
                (e in Zt && (r = r.map((n) => this.createChild(n))), !Ms.has(e))
              )
      ...
      var no2,
        ...
        yn2 = Me2((Ft2) => {
          ...
          var e,
            jt2,
            dn2 =
              (pn2(), (e = Fn2), nr2($e2({}, '__esModule', { value: !0 }), e)),
