    ...
    './src/stories/Page.stories.ts': (
      ...
      var Page = function () {
        var _React_useState = _sliced_to_array(react.useState(), 2),
          user = _React_useState[0],
          setUser = _React_useState[1];
        return react.createElement(
          'article',
          null,
          react.createElement(Header.Y, {
            user,
            onLogin: function () {
            ...
            ((_ref = (function _async_to_generator(fn) {
              ...
              return _ts_generator(this, function (_state) {
                switch (_state.label) {
                  case 0:
                    return (
                      (canvasElement = param.canvasElement),
                      (canvas = (0, dist.ux)(canvasElement)),
                      (loginButton = canvas.getByRole('button', {
                        name: /Log in/i,
                      })),
                      [4, (0, dist.E3)(loginButton).toBeInTheDocument()]
                    );
                  case 1:
                    return _state.sent(), [4, dist.Q4.click(loginButton)];
                  case 2:
                    return (
                      _state.sent(),
                      [4, (0, dist.E3)(loginButton).not.toBeInTheDocument()]
                    );
                  case 3:
                    return (
                      _state.sent(),
                      ...
                      [4, (0, dist.E3)(logoutButton).toBeInTheDocument()]
                    );
                  case 4:
